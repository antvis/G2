...
详细文档见 [Chart API](https://www.yuque.com/antv/g2-docs/api-chart)。

### Shape

构成图表具体的形状类。

详细文档见 [Shape API](https://www.yuque.com/antv/g2-docs/api-shape)。

### Scale

度量 Scale 类，是将原始数据转换为图形坐标的关键桥梁。

详细文档见 [Scale API](https://www.yuque.com/antv/g2-docs/api-scale)。

### Animate

负责 G2 图表的动画生成，以及提供自定义动画的机制。

详细文档见 [Animate API](https://www.yuque.com/antv/g2-docs/api-animate)。
...
2. 通过 `G2.Global.setTheme('dark')` 来切换或者设置皮肤，详细信息见[ 图表样式设置教程](https://www.yuque.com/antv/g2-docs/tutorial-creating-chart#ocqogt)。
