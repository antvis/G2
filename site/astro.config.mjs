...
const config = defineConfig({
  ...
  examples: [
    { slug: 'general', icon: 'gallery', title: { zh: '基础图表', en: 'General' } },
    { slug: 'analysis', icon: 'data', title: { zh: '数据分析', en: 'Analysis' } },
    { slug: 'graph', icon: 'net', title: { zh: '关系图', en: 'Graph' } },
    { slug: 'geo', icon: 'map', title: { zh: '地理', en: 'Geo' } },
    { slug: 'annotation', icon: 'guide', title: { zh: '数据标注', en: 'Annotation' } },
    { slug: 'composition', icon: 'facet', title: { zh: '复合视图', en: 'Composition' } },
    { slug: 'component', icon: 'block', title: { zh: '组件', en: 'Component' } },
    { slug: 'animation', icon: 'player-play', title: { zh: '动画', en: 'Animation' } },
    { slug: 'interaction', icon: 'interaction', title: { zh: '交互', en: 'Interaction' } },
    { slug: 'layout', icon: 'block', title: { zh: '布局', en: 'Layout' } },
    { slug: 'intelligent', icon: 'bulb', title: { zh: '智能可视化', en: 'Intelligent' } },
    { slug: 'storytelling', icon: 'story', title: { zh: '可视化叙事', en: 'Stroytelling' } },
    { slug: 'algorithm', icon: 'tool', title: { zh: '算法可视化', en: 'Algorithm Vis' } },
    { slug: 'unit', icon: 'shape', title: { zh: '单元可视化', en: 'Unit' } },
    { slug: 'threed', icon: 'cube', title: { zh: '3D 可视化', en: '3D Charts' } },
    { slug: 'interesting', icon: 'star', title: { zh: '趣味可视化', en: 'Interesting' } },
    { slug: 'scene', icon: 'case', title: { zh: '场景可视化', en: 'Scene Visualization' } },
    { slug: 'style', icon: 'skin', title: { zh: '风格', en: 'Style' } },
    { slug: 'renderer', icon: 'build', title: { zh: '渲染器', en: 'Renderer' } },
    { slug: 'accessible', icon: 'accessible', title: { zh: '无障碍', en: 'Accessible' } },
    {
      slug: 'expr',
      icon: 'execute',
      title: {
