...
<Demo src="charts/demos/parallel-en-1" />
...
<Demo src="charts/demos/parallel-en-6" />

### 带交互的平行坐标系

添加轴刷选和高亮功能，增强数据探索能力：

<Demo src="charts/demos/parallel-en-7" />
