...
<Demo src="manual/core/interaction/demos/elementHighlightByColor-en-1" />

### 带连接线高亮

<Demo src="manual/core/interaction/demos/elementHighlightByColor-en-2" />

### transpose

<Demo src="manual/core/interaction/demos/elementHighlightByColor-en-3" height={624} />
