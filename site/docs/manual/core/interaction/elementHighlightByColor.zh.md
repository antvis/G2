...
元素高亮样式，详见示例[自定义高亮](https://g2.antv.antgroup.com/manual/core/interaction/element-highlight#自定义高亮)
...
(() => {
  ...
  chart.options({
    ...
    axis: { y: { labelFormatter: '~s' } },
    interaction: { elementHighlightByColor: { link: true, background: true, link: true } },
  });
