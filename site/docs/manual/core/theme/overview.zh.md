...
| size | 默认大小 | `number` | `1` |  |
| category10 | 分类颜色方案（10色） | `string` \| `string[]` | 取决于主题 |  |
| category20 | 分类颜色方案（20色） | `string` \| `string[]` | 取决于主题 |  |
...
const chart = new Chart({
  ...
  chart.options({
    ...
    type: 'point',
    data: [
      { x: 1, y: 4 }, { x: 2, y: 5 }, { x: 3, y: 7 },
      { x: 4, y: 3 }, { x: 5, y: 6 }, { x: 6, y: 8 },
      { x: 7, y: 5 }, { x: 8, y: 9 }, { x: 9, y: 6 },
    ],
    encode: {
      x: 'x',
      y: 'y',
