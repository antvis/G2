...
<Demo height={304} code={`import { Chart } from '@antv/g2';
...
<Demo src="manual/core/demos/style-en-4" height={374} />
...
<Demo src="manual/core/demos/style-en-5" height={374} />

类似的，我们也可以以相同的方式来配置坐标轴的网格线。

<Demo src="manual/core/demos/style-en-6" />
...
<Demo src="manual/core/demos/style-en-9" height={374} />
...
<Demo src="manual/core/demos/style-en-11" height={374} />
...
<Demo src="manual/core/demos/style-en-12" height={374} />
