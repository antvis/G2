...
<Demo src="charts/demos/sunburst-en-9" />
...
<Demo src="manual/core/mark/demos/sunburst-en-2" />

尝试使用回调进行分组：

<Demo src="manual/core/mark/demos/sunburst-en-3" />
...
<Demo src="manual/core/mark/demos/sunburst-en-4" />

还原为直角坐标系 `cartesian` :

<Demo src="manual/core/mark/demos/sunburst-en-5" />

### interaction

`sunburst` 默认配置内置了 `drillDown` 交互事件,

<Demo code={`import { plotlib } from '@antv/g2-extension-plot';
