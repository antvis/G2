...
<Demo src="manual/core/mark/demos/boxplot-en-1" />

### 无异常点箱线图

通过设置 `point: false` 可以隐藏异常点，只显示箱体部分。

<Demo src="manual/core/mark/demos/boxplot-en-2" />

### 分组箱线图

使用 `color` 和 `series` 通道可以创建分组箱线图。

<Demo src="manual/core/mark/demos/boxplot-en-3" />

### 横向箱线图

通过坐标系转置可以创建横向箱线图。

<Demo src="manual/core/mark/demos/boxplot-en-4" />

### 小提琴图

通过设置 `shape: 'violin'` 可以创建小提琴图形状的箱线图。

<Demo src="manual/core/mark/demos/boxplot-en-5" />
