...
<Demo src="manual/core/mark/demos/gauge-en-5" height={374} />

## 示例

### 自定义仪表盘指针形状

<Demo src="manual/core/mark/demos/gauge-en-6" />
