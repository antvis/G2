...
<Demo src="manual/core/scale/demos/overview-en-1" />

When we try to change the scales of the x and y channels:

<Demo src="manual/core/scale/demos/overview-en-2" />
...
<Demo src="manual/core/scale/demos/overview-en-3" />

We can see the difference between `band` scale and `point` scale through the following examples:

`point` scale

<Demo src="manual/core/scale/demos/overview-en-4" height={664} />

`band` scale

<Demo src="manual/core/scale/demos/overview-en-5" height={664} />
...
<Demo src="manual/core/scale/demos/overview-en-6" />

`quantize` scale

<Demo src="manual/core/scale/demos/overview-en-7" />
...
<Demo src="manual/core/scale/demos/overview-en-8" />
...
<Demo src="manual/core/scale/demos/overview-en-11" />
