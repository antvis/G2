...
<Demo code={`import { table } from '@antv/astro-theme-antv/table';
...
<Demo src="manual/core/demos/encode-en-6" />
...
<Demo src="manual/core/demos/encode-en-7" />
...
<Demo src="manual/core/demos/encode-en-8" />
