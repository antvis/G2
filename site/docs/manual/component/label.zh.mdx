...
<Demo src="manual/component/demos/label-en-1" height={324} />
...
<Demo height={364} code={`import { Chart } from '@antv/g2';
...
<Demo height={324} code={`import { Chart } from '@antv/g2';
...
<Demo src="manual/component/demos/label-en-4" height={324} />

##### 配置 `overlapDodgeY` 转化标签

<Demo src="manual/component/demos/label-en-5" height={324} />
...
<Demo src="manual/component/demos/label-en-6" height={324} />

##### 配置 `contrastReverse` 转化标签

对不明显的 `label` 标签 颜色进行优化

<Demo src="manual/component/demos/label-en-7" height={324} />
...
<Demo src="manual/component/demos/label-en-8" />

##### 配置 `overflowStroke` 优化溢出标签的描边
<Demo src="manual/component/demos/label-en-9" />
...
<Demo src="manual/component/demos/label-en-10" />
...
<Demo src="manual/component/demos/label-en-12" height={324} />
...
<Demo src="manual/component/demos/label-en-13" height={324} />
...
<Demo height={334} code={`import { Chart } from '@antv/g2';
...
<Demo height={324} code={`import * as G2 from '@antv/g2';
