...
| titleFontSize      | 标题文字大小                                                                                                         | number \| (d, index, data) => number                                                                       | `12`                                  |      |
| titleFontFamily    | 标题文字字体                                                                                                         | string \| (d, index, data) => string                                                                       | -                                     |      |
| titleFontWeight    | 标题字体粗细                                                                                                         | number \| (d, index, data) => number                                                                       | `normal`                              |      |
| titleLineHeight    | 标题文字的行高                                                                                                       | number \| (d, index, data) => number                                                                       | -                                     |      |
...
| titleFill          | 标题字体颜色                                                                                                         | string \| (d, index, data) => string                                                                       | `#1D2129`                             |      |
| titleFillOpacity   | 标题字体颜色透明度                                                                                                   | number \| (d, index, data) => number                                                                       | `0.65`                                |      |
| titleStroke        | 标题字体描边颜色                                                                                                     | string \| (d, index, data) => string                                                                       | -                                     |      |
| titleStrokeOpacity | 标题字体描边颜色透明度                                                                                               | number \| (d, index, data) => number                                                                       | -                                     |      |
| titleLineWidth     | 标题字体描边的宽度                                                                                                   | number \| (d, index, data) => number                                                                       | -                                     |      |
| titleLineDash      | 标题字体描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]                                                   | -                                     |      |
| titleOpacity       | 标题文字的整体透明度                                                                                                 | number \| (d, index, data) => number                                                                       | -                                     |      |
| titleShadowColor   | 标题文字阴影颜色                                                                                                     | string \| (d, index, data) => string                                                                       | -                                     |      |
| titleShadowBlur    | 标题文字阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                                                                       | -                                     |      |
| titleShadowOffsetX | 设置阴影距标题文字的水平距离                                                                                         | number \| (d, index, data) => number                                                                       | -                                     |      |
| titleShadowOffsetY | 设置阴影距标题文字的垂直距离                                                                                         | number \| (d, index, data) => number                                                                       | -                                     |      |
| titleCursor        | 标题鼠标样式。同 css 的鼠标样式                                                                                      | string \| (d, index, data) => string                                                                       | `default`                             |      |
...
| 属性                    | 描述                                                                                                                   | 类型                                                     | 默认值    | 必选 |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | --------- | ---- |
| itemMarker              | 图例项图标                                                                                                             | _Symbols_ \|(d, index, data)=>_Symbols_                  | `circle`  |      |
| itemMarkerSize          | 图例项图标大小                                                                                                         | number \| (d, index, data) => number                     | `8`       |      |
| itemMarkerFill          | 图例项图标填充色                                                                                                       | string \| (d, index, data) => string                     | -         |      |
| itemMarkerFillOpacity   | 图例项图标填充透明度                                                                                                   | number \| (d, index, data) => number                     | `1`       |      |
| itemMarkerStroke        | 图例项图标的描边                                                                                                       | string \| (d, index, data) => string                     | -         |      |
| itemMarkerStrokeOpacity | 图例项图标描边透明度                                                                                                   | number \| (d, index, data) => number                     | -         |      |
| itemMarkerLineWidth     | 图例项图标描边的宽度                                                                                                   | number \| (d, index, data) => number                     | -         |      |
| itemMarkerLineDash      | 图例项图标描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number] | -         |      |
| itemMarkerOpacity       | 图例项图标的整体透明度                                                                                                 | number \| (d, index, data) => number                     | -         |      |
| itemMarkerShadowColor   | 图例项图标阴影颜色                                                                                                     | string \| (d, index, data) => string                     | -         |      |
| itemMarkerShadowBlur    | 图例项图标阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                     | -         |      |
| itemMarkerShadowOffsetX | 设置阴影距图例项图标的水平距离                                                                                         | number \| (d, index, data) => number                     | -         |      |
| itemMarkerShadowOffsetY | 设置阴影距图例项图标的垂直距离                                                                                         | number \| (d, index, data) => number                     | -         |      |
| itemMarkerCursor        | 图例项图标鼠标样式。同 css 的鼠标样式。                                                                                | string \| (d, index, data) => string                     | `default` |      |
...
| 属性                   | 描述                                                                                                                       | 类型                                                       | 默认值    | 必选 |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | --------- | ---- |
| itemLabelText          | 图例项标签内容                                                                                                             | string \| (d, index, data) => string                       | -         |      |
| itemLabelFontSize      | 图例项标签文字大小                                                                                                         | number \| (d, index, data) => number                       | `12`      |      |
| itemLabelFontFamily    | 图例项标签文字字体                                                                                                         | string \| (d, index, data) => string                       | -         |      |
| itemLabelFontWeight    | 图例项标签字体粗细                                                                                                         | number \| (d, index, data) => number                       | `normal`  |      |
| itemLabelLineHeight    | 图例项标签文字的行高                                                                                                       | number \| (d, index, data) => number                       | -         |      |
...
| itemLabelFill          | 图例项标签字体颜色                                                                                                         | string \| (d, index, data) => string                       | `#1D2129` |      |
| itemLabelFillOpacity   | 图例项标签字体颜色透明度                                                                                                   | number \| (d, index, data) => number                       | `0.9`     |      |
| itemLabelStroke        | 图例项标签字体描边颜色                                                                                                     | string \| (d, index, data) => string                       | -         |      |
| itemLabelStrokeOpacity | 图例项标签字体描边颜色透明度                                                                                               | number \| (d, index, data) => number                       | -         |      |
| itemLabelLineWidth     | 图例项标签字体描边的宽度                                                                                                   | number \| (d, index, data) => number                       | -         |      |
| itemLabelLineDash      | 图例项标签字体描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]   | -         |      |
| itemLabelOpacity       | 图例项标签文字的整体透明度                                                                                                 | number \| (d, index, data) => number                       | -         |      |
| itemLabelShadowColor   | 图例项标签文字阴影颜色                                                                                                     | string \| (d, index, data) => string                       | -         |      |
| itemLabelShadowBlur    | 图例项标签文字阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                       | -         |      |
| itemLabelShadowOffsetX | 设置阴影距图例项标签文字的水平距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| itemLabelShadowOffsetY | 设置阴影距图例项标签文字的垂直距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| itemLabelCursor        | 图例项标签鼠标样式。同 css 的鼠标样式                                                                                      | string \| (d, index, data) => string                       | `default` |      |
...
| 属性                   | 描述                                                                                                                     | 类型                                                       | 默认值    | 必选 |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------- | --------- | ---- |
| itemValueText          | 图例项值内容                                                                                                             | string \| (d, index, data) => string                       | -         |      |
| itemValueFontSize      | 图例项值文字大小                                                                                                         | number \| (d, index, data) => number                       | `12`      |      |
| itemValueFontFamily    | 图例项值文字字体                                                                                                         | string \| (d, index, data) => string                       | -         |      |
| itemValueFontWeight    | 图例项值字体粗细                                                                                                         | number \| (d, index, data) => number                       | `normal`  |      |
| itemValueLineHeight    | 图例项值文字的行高                                                                                                       | number \| (d, index, data) => number                       | -         |      |
...
| itemValueFill          | 图例项值字体颜色                                                                                                         | string \| (d, index, data) => string                       | `#1D2129` |      |
| itemValueFillOpacity   | 图例项值字体颜色透明度                                                                                                   | number \| (d, index, data) => number                       | `0.65`    |      |
| itemValueStroke        | 图例项值字体描边颜色                                                                                                     | string \| (d, index, data) => string                       | -         |      |
| itemValueStrokeOpacity | 图例项值字体描边颜色透明度                                                                                               | number \| (d, index, data) => number                       | -         |      |
| itemValueLineWidth     | 图例项值字体描边的宽度                                                                                                   | number \| (d, index, data) => number                       | -         |      |
| itemValueLineDash      | 图例项值字体描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]   | -         |      |
| itemValueOpacity       | 图例项值文字的整体透明度                                                                                                 | number \| (d, index, data) => number                       | -         |      |
| itemValueShadowColor   | 图例项值文字阴影颜色                                                                                                     | string \| (d, index, data) => string                       | -         |      |
| itemValueShadowBlur    | 图例项值文字阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                       | -         |      |
| itemValueShadowOffsetX | 设置阴影距图例项值文字的水平距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| itemValueShadowOffsetY | 设置阴影距图例项值文字的垂直距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| itemValueCursor        | 图例项值鼠标样式。同 css 的鼠标样式                                                                                      | string \| (d, index, data) => string                       | `default` |      |
...
| 属性                        | 描述                                                                                                                   | 类型                                                     | 默认值        | 必选 |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ------------- | ---- |
| itemBackgroundFill          | 图例项背景填充色                                                                                                       | string \| (d, index, data) => string                     | `transparent` |      |
| itemBackgroundFillOpacity   | 图例项背景填充透明度                                                                                                   | number \| (d, index, data) => number                     | -             |      |
| itemBackgroundStroke        | 图例项背景的描边                                                                                                       | string \| (d, index, data) => string                     | -             |      |
| itemBackgroundStrokeOpacity | 图例项背景描边透明度                                                                                                   | number \| (d, index, data) => number                     | -             |      |
| itemBackgroundLineWidth     | 图例项背景描边的宽度                                                                                                   | number \| (d, index, data) => number                     | -             |      |
| itemBackgroundLineDash      | 图例项背景描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number] | -             |      |
| itemBackgroundOpacity       | 图例项背景的整体透明度                                                                                                 | number \| (d, index, data) => number                     | -             |      |
| itemBackgroundShadowColor   | 图例项背景阴影颜色                                                                                                     | string \| (d, index, data) => string                     | -             |      |
| itemBackgroundShadowBlur    | 图例项背景阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                     | -             |      |
| itemBackgroundShadowOffsetX | 设置阴影距图例项背景的水平距离                                                                                         | number \| (d, index, data) => number                     | -             |      |
| itemBackgroundShadowOffsetY | 设置阴影距图例项背景的垂直距离                                                                                         | number \| (d, index, data) => number                     | -             |      |
| itemBackgroundCursor        | 图例项背景鼠标样式。同 css 的鼠标样式。                                                                                | string \| (d, index, data) => string                     | `default`     |      |
...
| navPageNumFontSize      | 分页器数字文字大小                                                                                                         | number \| (d, index, data) => number                                       | `12`         |      |
| navPageNumFontFamily    | 分页器数字文字字体                                                                                                         | string \| (d, index, data) => string                                       | -            |      |
| navPageNumFontWeight    | 分页器数字字体粗细                                                                                                         | number \| (d, index, data) => number                                       | `normal`     |      |
| navPageNumLineHeight    | 分页器数字文字的行高                                                                                                       | number \| (d, index, data) => number                                       | -            |      |
...
| navPageNumFill          | 分页器数字字体颜色                                                                                                         | string \| (d, index, data) => string                                       | `#1D2129`    |      |
| navPageNumFillOpacity   | 分页器数字字体颜色透明度                                                                                                   | number \| (d, index, data) => number                                       | `0.45`       |      |
| navPageNumStroke        | 分页器数字字体描边颜色                                                                                                     | string \| (d, index, data) => string                                       | -            |      |
| navPageNumStrokeOpacity | 分页器数字字体描边颜色透明度                                                                                               | number \| (d, index, data) => number                                       | -            |      |
| navPageNumLineWidth     | 分页器数字字体描边的宽度                                                                                                   | number \| (d, index, data) => number                                       | -            |      |
| navPageNumLineDash      | 分页器数字字体描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]                   | -            |      |
| navPageNumOpacity       | 分页器数字文字的整体透明度                                                                                                 | number \| (d, index, data) => number                                       | -            |      |
| navPageNumShadowColor   | 分页器数字文字阴影颜色                                                                                                     | string \| (d, index, data) => string                                       | -            |      |
| navPageNumShadowBlur    | 分页器数字文字阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                                       | -            |      |
| navPageNumShadowOffsetX | 设置阴影距分页器数字文字的水平距离                                                                                         | number \| (d, index, data) => number                                       | -            |      |
| navPageNumShadowOffsetY | 设置阴影距分页器数字文字的垂直距离                                                                                         | number \| (d, index, data) => number                                       | -            |      |
| navPageNumCursor        | 分页器数字鼠标样式。同 css 的鼠标样式                                                                                      | string \| (d, index, data) => string                                       | `default`    |      |
| navButtonFill           | 分页器按钮填充色                                                                                                           | string \| (d, index, data) => string                                       | `#1D2129`    |      |
| navButtonFillOpacity    | 分页器按钮填充透明度                                                                                                       | number \| (d, index, data) => number                                       | `0.65`       |      |
| navButtonStroke         | 分页器按钮的描边                                                                                                           | string \| (d, index, data) => string                                       | -            |      |
| navButtonStrokeOpacity  | 分页器按钮描边透明度                                                                                                       | number \| (d, index, data) => number                                       | -            |      |
| navButtonLineWidth      | 分页器按钮描边的宽度                                                                                                       | number \| (d, index, data) => number                                       | -            |      |
| navButtonLineDash       | 分页器按钮描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。     | [number,number] \| (d, index, data) => [number , number]                   | -            |      |
| navButtonOpacity        | 分页器按钮的整体透明度                                                                                                     | number \| (d, index, data) => number                                       | -            |      |
| navButtonShadowColor    | 分页器按钮阴影颜色                                                                                                         | string \| (d, index, data) => string                                       | -            |      |
| navButtonShadowBlur     | 分页器按钮阴影的高斯模糊系数                                                                                               | number \| (d, index, data) => number                                       | -            |      |
| navButtonShadowOffsetX  | 设置阴影距分页器按钮的水平距离                                                                                             | number \| (d, index, data) => number                                       | -            |      |
| navButtonShadowOffsetY  | 设置阴影距分页器按钮的垂直距离                                                                                             | number \| (d, index, data) => number                                       | -            |      |
| navButtonCursor         | 分页器按钮鼠标样式。同 css 的鼠标样式。                                                                                    | string \| (d, index, data) => string                                       | `default`    |      |
...
| 属性                | 描述                                                                                                             | 类型                                                     | 默认值    | 必选 |
| ------------------- | ---------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | --------- | ---- |
| ribbonSize          | 色带大小                                                                                                         | number \| (d, index, data) => number                     | `12`      |      |
| ribbonFill          | 色带填充色                                                                                                       | string \| (d, index, data) => string                     | `#aaa`    |      |
| ribbonFillOpacity   | 色带填充透明度                                                                                                   | number \| (d, index, data) => number                     | -         |      |
| ribbonStroke        | 色带的描边                                                                                                       | string \| (d, index, data) => string                     | -         |      |
| ribbonStrokeOpacity | 色带描边透明度                                                                                                   | number \| (d, index, data) => number                     | -         |      |
| ribbonLineWidth     | 色带描边的宽度                                                                                                   | number \| (d, index, data) => number                     | -         |      |
| ribbonLineDash      | 色带描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number] | -         |      |
| ribbonOpacity       | 色带的整体透明度                                                                                                 | number \| (d, index, data) => number                     | -         |      |
| ribbonShadowColor   | 色带阴影颜色                                                                                                     | string \| (d, index, data) => string                     | -         |      |
| ribbonShadowBlur    | 色带阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                     | -         |      |
| ribbonShadowOffsetX | 设置阴影距色带的水平距离                                                                                         | number \| (d, index, data) => number                     | -         |      |
| ribbonShadowOffsetY | 设置阴影距色带的垂直距离                                                                                         | number \| (d, index, data) => number                     | -         |      |
| ribbonCursor        | 色带鼠标样式。同 css 的鼠标样式。                                                                                | string \| (d, index, data) => string                     | `default` |      |
...
| handleLabelFontSize       | 手柄标签文字大小                                                                                                         | number \| (d, index, data) => number                       | `12`         |      |
| handleLabelFontFamily     | 手柄标签文字字体                                                                                                         | string \| (d, index, data) => string                       | -            |      |
| handleLabelFontWeight     | 手柄标签字体粗细                                                                                                         | number \| (d, index, data) => number                       | `normal`     |      |
| handleLabelLineHeight     | 手柄标签文字的行高                                                                                                       | number \| (d, index, data) => number                       | -            |      |
...
| handleLabelFill           | 手柄标签字体颜色                                                                                                         | string \| (d, index, data) => string                       | `#1D2129`    |      |
| handleLabelFillOpacity    | 手柄标签字体颜色透明度                                                                                                   | number \| (d, index, data) => number                       | `0.45`       |      |
| handleLabelStroke         | 手柄标签字体描边颜色                                                                                                     | string \| (d, index, data) => string                       | -            |      |
| handleLabelStrokeOpacity  | 手柄标签字体描边颜色透明度                                                                                               | number \| (d, index, data) => number                       | -            |      |
| handleLabelLineWidth      | 手柄标签字体描边的宽度                                                                                                   | number \| (d, index, data) => number                       | -            |      |
| handleLabelLineDash       | 手柄标签字体描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]   | -            |      |
| handleLabelOpacity        | 手柄标签文字的整体透明度                                                                                                 | number \| (d, index, data) => number                       | -            |      |
| handleLabelShadowColor    | 手柄标签文字阴影颜色                                                                                                     | string \| (d, index, data) => string                       | -            |      |
| handleLabelShadowBlur     | 手柄标签文字阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                       | -            |      |
| handleLabelShadowOffsetX  | 设置阴影距手柄标签文字的水平距离                                                                                         | number \| (d, index, data) => number                       | -            |      |
| handleLabelShadowOffsetY  | 设置阴影距手柄标签文字的垂直距离                                                                                         | number \| (d, index, data) => number                       | -            |      |
| handleLabelCursor         | 手柄标签鼠标样式。同 css 的鼠标样式                                                                                      | string \| (d, index, data) => string                       | `default`    |      |
| handleMarkerFill          | 手柄图标填充色                                                                                                           | string \| (d, index, data) => string                       | `#1D2129`    |      |
| handleMarkerFillOpacity   | 手柄图标填充透明度                                                                                                       | number \| (d, index, data) => number                       | `0.65`       |      |
| handleMarkerStroke        | 手柄图标的描边                                                                                                           | string \| (d, index, data) => string                       | -            |      |
| handleMarkerStrokeOpacity | 手柄图标描边透明度                                                                                                       | number \| (d, index, data) => number                       | -            |      |
| handleMarkerLineWidth     | 手柄图标描边的宽度                                                                                                       | number \| (d, index, data) => number                       | -            |      |
| handleMarkerLineDash      | 手柄图标描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。     | [number,number] \| (d, index, data) => [number , number]   | -            |      |
| handleMarkerOpacity       | 手柄图标的整体透明度                                                                                                     | number \| (d, index, data) => number                       | -            |      |
| handleMarkerShadowColor   | 手柄图标阴影颜色                                                                                                         | string \| (d, index, data) => string                       | -            |      |
| handleMarkerShadowBlur    | 手柄图标阴影的高斯模糊系数                                                                                               | number \| (d, index, data) => number                       | -            |      |
| handleMarkerShadowOffsetX | 设置阴影距手柄图标的水平距离                                                                                             | number \| (d, index, data) => number                       | -            |      |
| handleMarkerShadowOffsetY | 设置阴影距手柄图标的垂直距离                                                                                             | number \| (d, index, data) => number                       | -            |      |
| handleMarkerCursor        | 手柄图标鼠标样式。同 css 的鼠标样式。                                                                                    | string \| (d, index, data) => string                       | `default`    |      |
...
| labelFormatter          | 连续图例的刻度值格式化                                                                                                         | (d, index, data)=>string                                   | -          |      |
| labelFilter             | 连续图例的刻度值过滤                                                                                                           | (d, index, data)=>boolean                                  | -          |      |
...
| labelLabelFontSize      | 连续图例刻度值文字大小                                                                                                         | number \| (d, index, data) => number                       | `12`       |      |
| labelLabelFontFamily    | 连续图例刻度值文字字体                                                                                                         | string \| (d, index, data) => string                       | -          |      |
| labelLabelFontWeight    | 连续图例刻度值字体粗细                                                                                                         | number \| (d, index, data) => number                       | `normal`   |      |
| labelLabelLineHeight    | 连续图例刻度值文字的行高                                                                                                       | number \| (d, index, data) => number                       | -          |      |
...
| labelLabelFill          | 连续图例刻度值字体颜色                                                                                                         | string \| (d, index, data) => string                       | `#1D2129`  |      |
| labelLabelFillOpacity   | 连续图例刻度值字体颜色透明度                                                                                                   | number \| (d, index, data) => number                       | `0.45`     |      |
| labelLabelStroke        | 连续图例刻度值字体描边颜色                                                                                                     | string \| (d, index, data) => string                       | -          |      |
| labelLabelStrokeOpacity | 连续图例刻度值字体描边颜色透明度                                                                                               | number \| (d, index, data) => number                       | -          |      |
| labelLabelLineWidth     | 连续图例刻度值字体描边的宽度                                                                                                   | number \| (d, index, data) => number                       | -          |      |
| labelLabelLineDash      | 连续图例刻度值字体描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]   | -          |      |
| labelLabelOpacity       | 连续图例刻度值文字的整体透明度                                                                                                 | number \| (d, index, data) => number                       | -          |      |
| labelLabelShadowColor   | 连续图例刻度值文字阴影颜色                                                                                                     | string \| (d, index, data) => string                       | -          |      |
| labelLabelShadowBlur    | 连续图例刻度值文字阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                       | -          |      |
| labelLabelShadowOffsetX | 设置阴影距连续图例刻度值文字的水平距离                                                                                         | number \| (d, index, data) => number                       | -          |      |
| labelLabelShadowOffsetY | 设置阴影距连续图例刻度值文字的垂直距离                                                                                         | number \| (d, index, data) => number                       | -          |      |
| labelLabelCursor        | 手柄标签鼠标样式。同 css 的鼠标样式                                                                                            | string \| (d, index, data) => string                       | `default`  |      |
...
| indicatorFormatter               | 值指示器格式化                                                                                                           | (d, index, data)=>string                                   | -         |      |
| indicatorLabelFontSize           | 值指示器文字大小                                                                                                         | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelFontFamily         | 值指示器文字字体                                                                                                         | string \| (d, index, data) => string                       | -         |      |
| indicatorLabelFontWeight         | 值指示器字体粗细                                                                                                         | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelLineHeight         | 值指示器文字的行高                                                                                                       | number \| (d, index, data) => number                       | -         |      |
...
| indicatorLabelFill               | 值指示器字体颜色                                                                                                         | string \| (d, index, data) => string                       | -         |      |
| indicatorLabelFillOpacity        | 值指示器字体颜色透明度                                                                                                   | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelStroke             | 值指示器字体描边颜色                                                                                                     | string \| (d, index, data) => string                       | -         |      |
| indicatorLabelStrokeOpacity      | 值指示器字体描边颜色透明度                                                                                               | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelLineWidth          | 值指示器字体描边的宽度                                                                                                   | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelLineDash           | 值指示器字体描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]   | -         |      |
| indicatorLabelOpacity            | 值指示器文字的整体透明度                                                                                                 | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelShadowColor        | 值指示器文字阴影颜色                                                                                                     | string \| (d, index, data) => string                       | -         |      |
| indicatorLabelShadowBlur         | 值指示器文字阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelShadowOffsetX      | 设置阴影距值指示器文字的水平距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelShadowOffsetY      | 设置阴影距值指示器文字的垂直距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| indicatorLabelCursor             | 值指示器鼠标样式。同 css 的鼠标样式                                                                                      | string \| (d, index, data) => string                       | `default` |      |
| indicatorBackgroundFill          | 值指示器背景填充色                                                                                                       | string \| (d, index, data) => string                       | -         |      |
| indicatorBackgroundFillOpacity   | 值指示器背景填充透明度                                                                                                   | number \| (d, index, data) => number                       | -         |      |
| indicatorBackgroundStroke        | 值指示器背景的描边                                                                                                       | string \| (d, index, data) => string                       | -         |      |
| indicatorBackgroundStrokeOpacity | 值指示器背景描边透明度                                                                                                   | number \| (d, index, data) => number                       | -         |      |
| indicatorBackgroundLineWidth     | 值指示器背景描边的宽度                                                                                                   | number \| (d, index, data) => number                       | -         |      |
| indicatorBackgroundLineDash      | 值指示器背景描边的虚线配置，第一个值为虚线每个分段的长度，第二个值为分段间隔的距离。lineDash 设为[0,0]的效果为没有描边。 | [number,number] \| (d, index, data) => [number , number]   | -         |      |
| indicatorBackgroundOpacity       | 值指示器背景的整体透明度                                                                                                 | number \| (d, index, data) => number                       | -         |      |
| indicatorBackgroundShadowColor   | 值指示器背景阴影颜色                                                                                                     | string \| (d, index, data) => string                       | -         |      |
| indicatorBackgroundShadowBlur    | 值指示器背景阴影的高斯模糊系数                                                                                           | number \| (d, index, data) => number                       | -         |      |
| indicatorBackgroundShadowOffsetX | 设置阴影距值指示器背景的水平距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| indicatorBackgroundShadowOffsetY | 设置阴影距值指示器背景的垂直距离                                                                                         | number \| (d, index, data) => number                       | -         |      |
| indicatorBackgroundCursor        | 值指示器背景鼠标样式。同 css 的鼠标样式。                                                                                | string \| (d, index, data) => string                       | `default` |      |
| navFormatter                     | 页码文本格式化                                                                                                           | (current: number, total: number) => string                 | -         |      |
