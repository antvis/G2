...
<Demo src="manual/whats-new/demos/new-version-features-en-4" />
...
<Demo src="manual/whats-new/demos/new-version-features-en-6" />
...
<Demo src="manual/whats-new/demos/new-version-features-en-8" />
...
<Demo height={384} code={`import * as G2 from '@antv/g2';
...
<Demo height={174} code={`import * as G2 from '@antv/g2';
