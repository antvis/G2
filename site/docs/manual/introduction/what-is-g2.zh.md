...
这是在 G2 官网特定运行环境的语法，在实际项目中使用 G2 请参考[开始使用](/manual/introduction/getting-started)。
:::
...
因为 G2 的标记是可以组合的，同时提供了**复合标记**的机制去扩展 G2，所以你基本上可以快速绘制任意的可视化。在[案例页面](/examples)你可以获得更多灵感，也可以通过[选项页面](/spec/overview)全面了解 G2 的能力。
