...
class ChartGuide {
  line: (
    option: {
      ...
      end?: any | ChartGuideCallBack | Array<string | number>;
  ...
  text: (
    option: {
      ...
      position?: any | ChartGuideCallBack | Array<string | number>;
      // 显示的文本内容
      content?: string;
      style?: {
        // 文本的颜色
  ...
  image: (
    option: {
      ...
      start?: any | ChartGuideCallBack | Array<string | number>;
