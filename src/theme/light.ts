...
export const LIGHT_STYLESHEET: StyleSheet = {
  name: 'light',
  ...
  /** 连续图例滑块填充色 */
  legendRailFillColor: BLACK_COLORS[15],
  /** 连续图例滑块边框粗细 */
  legendRailBorder: 0,
  /** 连续图例滑块边框颜色 */
  legendRailBorderColor: null,
  /** 连续图例滑块宽度 */
  legendRailWidth: 100,
  /** 连续图例滑块高度 */
  legendRailHeight: 12,
  ...
  /** 连续图例文本颜色 */
  legendRailLabelTextFillColor: BLACK_COLORS[45],
  /** 连续图例文本字体大小 */
  legendRailLabelTextFontSize: 12,
  /** 连续图例文本行高 */
  legendRailLabelTextLineHeight: 12,
  /** 连续图例文本字体粗细 */
  legendRailLabelTextFontWeight: 'normal',

  /** 连续图例滑块颜色 */
  legendHandlerFillColor: BLACK_COLORS[6],
  /** 连续图例滑块宽度 */
  legendHandlerWidth: 10,
  /** 连续图例滑块高度 */
  legendHandlerHeight: 14,
  /** 连续图例滑块边框粗细 */
  legendHandlerBorder: 1,
  /** 连续图例滑块边框颜色 */
  legendHandlerBorderColor: BLACK_COLORS[25],
  ...
  sliderRailHieght: 16,
  /** slider 滑道背景色 */
  sliderBackgroundFillColor: '#416180',
  /** slider 滑道背景色透明度 */
  sliderBackgroundFillOpacity: 0.05,
  /** slider 滑道前景色 */
  sliderForegroundFillColor: '#5B8FF9',
  /** slider 滑道前景色透明度 */
  sliderForegroundFillOpacity: 0.15,
  // slider handlerStyle 手柄样式
  /** slider 手柄高度 */
  sliderHandlerHeight: 24,
  /** Slider 手柄宽度 */
  sliderHandlerWidth: 10,
  /** Slider 手柄背景色 */
  sliderHandlerFillColor: '#F7F7F7',
  /** Slider 手柄背景色透明度 */
  sliderHandlerFillOpacity: 1,
  /** Slider 手柄高亮背景色 */
  sliderHandlerHighlightFillColor: '#FFF',
  /** Slider 手柄边框色 */
  sliderHandlerBorderColor: '#BFBFBF',
  /** Slider 手柄边框粗细 */
  sliderHandlerBorder: 1,
  /** Slider 手柄边框圆角 */
  sliderHandlerBorderRadius: 2,
  // slider textStyle 字体标签样式
  /** Slider 字体标签颜色 */
  sliderTextFillColor: '#000',
  /** Slider 字体标签透明度 */
  sliderTextFillOpacity: 0.45,
  /** Slider 字体标签大小 */
  sliderTextFontSize: 12,
  /** Slider 字体标签行高 */
  sliderTextLineHeight: 12,
  /** Slider 字体标签字重 */
  sliderTextFontWeight: 'normal',
  /** Slider 字体标签描边色 */
  sliderTextBorderColor: null,
  /** Slider 字体标签描边粗细 */
  sliderTextBorder: 0,
