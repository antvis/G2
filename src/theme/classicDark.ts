  ...
  const defaultOptions: Theme = {
    ...
    axis: {
      ...
      style: {
        ...
        gridLineDash: [0, 0],
        gridLineWidth: 0.5,
        gridStroke: ColorToken.white1,
        gridStrokeOpacity: 0.05,
        labelAlign: 'horizontal',
        labelFill: ColorToken.white1,
        ...
        line: false,
        lineLineWidth: 0.5,
        lineStroke: ColorToken.white1,
        lineStrokeOpacity: 0.45,
        tickLength: 4,
        tickLineWidth: 1,
        tickStroke: ColorToken.white1,
        tickStrokeOpacity: 0.25,
        titleFill: ColorToken.white1,
    ...
    legendCategory: {
      ...
      style: {
        ...
        itemLabelFill: ColorToken.white1,
    ...
    slider: {
      ...
      style: {
        ...
        handleIconStroke: ColorToken.white1,
    ...
    title: {
      ...
      style: {
        ...
        titleTextBaseline: 'top',
        subtitleFill: ColorToken.white1,
