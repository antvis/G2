...
describe('edge', () => {
  ...
  it.skip('render({...}) should render sankey plot', () => {
    // const chart = render<G2Spec>({
    //   type: 'view',
    //   data: SANKEY_DATA,
    //   paddingBottom: 5,
  ...
  it.skip('render({...}) should render arc diagram', () => {
    // const chart = render<G2Spec>({
    //   type: 'view',
    //   transform: [
    //     {
  ...
  it.skip('render({...}) should render arc diagram in polar', () => {
    // const chart = render<G2Spec>({
    //   type: 'view',
    //   transform: [
    //     {
  ...
  it.skip('render({...}) should render chord diagram', () => {
    // const chart = render<G2Spec>({
    //   type: 'view',
    //   transform: [
    //     {
