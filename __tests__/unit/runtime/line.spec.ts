...
describe('line', () => {
  ...
  it('render({...}) should render gradient line chart', () => {
    const chart = render<G2Spec>({
      type: 'line',
      data: [
        { year: '1991', value: 15468 },
  ...
  it('render({...}) should render basic line chart with hv shape', () => {
    const chart = render<G2Spec>({
      type: 'line',
      data: [
        { year: '1991', value: 15468 },
  ...
  it('render({...}) should render basic line chart with vh shape', () => {
    const chart = render<G2Spec>({
      type: 'line',
      data: [
        { year: '1991', value: 15468 },
  ...
  it('render({...}) should render basic line chart with hvh shape', () => {
    const chart = render<G2Spec>({
      type: 'line',
      data: [
        { year: '1991', value: 15468 },
