...
import * as PathUtil from '../../../../src/element/util/path';
...
describe('PathUtil', () => {
  ...
  it('get coord radius', () => {
    ...
    expect(PathUtil.getPointRadius(coord, {
      x: 100,
      y: 100,
    })).equal(0);
    expect(PathUtil.getPointRadius(coord, {
  ...
  it('get Point Angle', () => {
    ...
    expect(PathUtil.getPointAngle(coord, {
      x: 100,
      y: 100,
    })).equal(0);
    expect(PathUtil.getPointAngle(coord, {
  ...
  it('convertNormalPath', () => {
    ...
    expect(PathUtil.convertNormalPath(coord, path)).eqls([
      [ 'M', 0, 0 ],
      [ 'L', 200, 200 ],
    ]);
  });
