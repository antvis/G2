...
describe('Polygon shape factory', function() {
  ...
  before(() => {
    ...
    canvas = new Canvas({
      containerId: 'polygon-shape',
      width: 500,
      height: 500,
    });

    PolygonShapeFactory.setCoord(coord);
    PolygonShapeFactory.setTheme(Global.theme.shape);
  });

  describe('default', function() {
    it('default shape type', function() {
      expect(PolygonShapeFactory.defaultShapeType).to.be.equal('polygon');
    });
  });
  ...
  describe('polygon', function() {
    ...
    it('getMarkerStyle', function() {
      const markerCfg = PolygonShapeFactory.getMarkerStyle('polygon', {
        color: '#f80',
      });
    ...
    it('getActiveStyle', function() {
      const activeCfg = PolygonShapeFactory.getActiveStyle('polygon', {});
  ...
  describe('polygon has no points cfg', function() {
    it('getShapePoints && drawShape', function() {
      const type = 'polygon';
      const points = [];
      const shape = PolygonShapeFactory.drawShape(type, { points }, canvas);
      expect(shape).eql(undefined);
      canvas.draw();
    });
  });
  ...
  describe('hollow', function() {
    ...
    it('getMarkerStyle', function() {
      const markerCfg = PolygonShapeFactory.getMarkerStyle('hollow', {
        color: '#f80',
      });
      expect(markerCfg.symbol).eql('square');
    });
    ...
    it('getActiveStyle', function() {
      const activeCfg = PolygonShapeFactory.getActiveStyle('hollow', {});
      expect(activeCfg).eql({
        lineWidth: 2,
      });
    });
  ...
  describe('hollow has points cfg', function() {
    it('getShapePoints && drawShape', function() {
      const type = 'hollow';
      const points = [
        { x: 0.1, y: 0.2 },
      ...
      const shape = PolygonShapeFactory.drawShape(type, { points, color: 'blue' }, canvas);
      expect(shape.attr('stroke')).eql('blue');
      expect(shape.attr('path').length).eql(7);
      expect(shape.attr('path')[0].length).eql(3);
      expect(shape.attr('path')[1].length).eql(3);
  ...
  describe('hollow has no points cfg', function() {
    it('getShapePoints && drawShape', function() {
      const type = 'hollow';
      const points = [];
      const shape = PolygonShapeFactory.drawShape(type, { points }, canvas);
    ...
    it('getShapePoints && drawShape', function() {
      ...
      const points = PolygonShapeFactory.getShapePoints(type, {
        x: [
          ...
          0.24324318427441322,
          0.21263260173587847,
          0.019262312767244327,
          0.010303165180830014,
          0,
          0.027027020474935184,
          0.019262312767244327,
          0.9514708798612144,
          0.9528146550282112,
          0.9523666491634082,
        ...
        y: [
          ...
          0.18704775058312698,
          0.10066323704390037,
          0.033770192090339365,
          0.02164413233938894,
          0,
          0.007308276055652992,
          0.033770192090339365,
          0.08539661326821875,
          0.11537368563557733,
          0.1350233871789078,
  ...
  describe('registerShape', () => {
    ...
    it('getActiveStyle()', () => {
      const activeStyle = PolygonShapeFactory.getActiveStyle('test');
