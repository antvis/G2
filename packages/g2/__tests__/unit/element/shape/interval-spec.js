...
describe('Interval shape', () => {
  ...
  describe('rect', () => {
    it('draw', () => {
      ...
      const shape = IntervalShapeFactory.drawShape('rect', {
        points,
        color: 'red',
      }, canvas);
      canvas.draw();
    ...
    it('getMarkerStyle()', () => {
      ...
      expect(markerStyle).to.eql(mix({}, Global.theme.shape.interval.rect.default, {
        radius: 4,
        symbol: 'square',
        fill: 'red',
      }));
  ...
  describe('hollowInterval', () => {
    it('draw', () => {
      ...
      const shape = IntervalShapeFactory.drawShape('hollowInterval', {
        points,
        color: 'yellow',
      }, canvas);
      canvas.draw();
    ...
    it('getMarkerStyle()', () => {
      ...
      expect(markerStyle).to.eql(mix({}, Global.theme.shape.interval.hollowInterval.default, {
        stroke: 'yellow',
        symbol: 'square',
        radius: 4,
      }));
  ...
  describe('hollowInterval in polar coord', () => {
    it('draw', () => {
      ...
      expect(isNumberEqual(Math.sqrt(Math.pow(path[1][1] - path[0][1], 2) + Math.pow(path[1][2] - path[0][2], 2)), polarCoord.getRadius() * 0.2)).to.be.true;
    });
  ...
  describe('line', () => {
    ...
    it('draw', () => {
      ...
      const points = IntervalShapeFactory.getShapePoints('line', cfg);
      const shape = IntervalShapeFactory.drawShape('line', {
        color: 'green',
        points,
        size: 5,
      }, canvas);
  ...
  describe('tick', () => {
    ...
    it('draw', () => {
      ...
      const points = IntervalShapeFactory.getShapePoints('tick', cfg);
      const shape = IntervalShapeFactory.drawShape('tick', {
        points,
        color: 'pink',
      }, canvas);
      canvas.draw();
  ...
  describe('funnel', () => {
    ...
    it('draw, nextPoints is null', () => {
      ...
      const points = IntervalShapeFactory.getShapePoints('funnel', cfg);
      const shape = IntervalShapeFactory.drawShape('funnel', {
        points,
        nextPoints: null,
      }, canvas);
      canvas.draw();
  ...
  describe('pyramid', () => {
    ...
    it('draw, nextPoints is null', () => {
      ...
      const points = IntervalShapeFactory.getShapePoints('pyramid', cfg);
      const shape = IntervalShapeFactory.drawShape('pyramid', {
        points,
        nextPoints: null,
      }, canvas);
      canvas.draw();
  ...
  describe('top-line', () => {
    ...
    it('draw, with style', () => {
      ...
      const shape = IntervalShapeFactory.drawShape('top-line', {
        points,
        color: '#F04864',
        style: {
          stroke: '#000',
