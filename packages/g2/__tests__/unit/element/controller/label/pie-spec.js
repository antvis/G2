...
describe('pie labels', function() {
  ...
  describe('pie text outter with offsetX & offsetY', function() {
    ...
    it('points', function() {
      ...
      expect(_.isNumberEqual(items[0].y, 48.03847577293368 - 10)).to.be.true;
      expect(items[1].x).to.equal(200);
      expect(_.isNumberEqual(items[1].y, 100 - 10)).to.be.true;
      expect(items[2].x).to.equal(230.00000000000006);
      expect(_.isNumberEqual(items[2].y, 151.96152422706632 - 10)).to.be.true;
      expect(items[5].x).to.equal(290);
      expect(_.isNumberEqual(items[5].y, 151.96152422706632 - 10)).to.be.true;
    });
  });
